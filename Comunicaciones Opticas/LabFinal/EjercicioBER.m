...
Lambda = 820e-9; %Longitud de onda (m)
Alpha = 0.5; %Coeficiente de atenuación (dB/Km)
RL = 100;%Resistencia de carga (Ohms)
T = 300;%Temperatura (K)
Lc = 1; %Perdida por conector (dB)
n1 = 1.5; %Indice de refracción n1
n2 = 1.48; %Indice de refracción n2
Pe = 4e-4;%Tasa de error de bit
DF = 1e6;%Ancho de banda
n = 1; %Eficiencia cuántica
D = 50e-6; %Diametro
